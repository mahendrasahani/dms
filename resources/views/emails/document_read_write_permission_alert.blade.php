...
<head>
    ...
    <title>Read Write Permission</title>
        ...
        <div class="emailMSG" style="max-width: 600px; margin: 0 auto; border: 1px solid gainsboro;">
            ...
            <div class="emailBox">
                ...
                <div class="msgtext" style="padding: 1.5rem;">
                    <center>
                        <h4 style="margin: .5rem 0; color: #253a76;">Document Read/Write Permission Update Notification</h4>
                    </center>
                    <p style="font-size: 15px;">Hi, <b style="color: #253a76;">{{$doc_r_w_permission_mail_data['user_name']}}</b></p>
                    <p style="font-size: 15px;">We are notifying you that your document read/write permission have been updated.</p>
                    <p style="font-size: 15px;">You now have the following access:</p>
                    <div class="userForm">
                        <div class="userDetails">
                            ...
                            <div style="border: 1px solid gainsboro; font-size: 15px;">
                                <div class="w"
                                    ...
                                    {{$doc_r_w_permission_mail_data['main_folder']}}
                                </div>
                            ...
                            <div style="border: 1px solid gainsboro; border-top: none;">
                                <div class="w"
                                    style="width: 49%; float: right; border-left: 1px solid gainsboro; padding: 7px 8px; font-size: 15px;">
                                    {{$doc_r_w_permission_mail_data['sub_folder']}}
                                </div>
                                <div style="width: 49%; padding: 7px 8px; font-size: 15px;">
                                <span><b style="color: #1a2c61;">Sub Folder:</b></span>
                                </div>
                            </div>
                            <div style="border: 1px solid gainsboro; border-top: none;">
                                <div class="w"
                                    style="width: 49%; float: right; border-left: 1px solid gainsboro; padding: 7px 8px; font-size: 15px;">
                                    {{$doc_r_w_permission_mail_data['doc_title'] ?? 'No Title'}}
                                </div>
                                <div style="width: 49%; padding: 7px 8px; font-size: 15px;">
                                    <span><b style="color: #1a2c61;">Document:</b></span>
                                </div>
                            </div>
                            <div style="border: 1px solid gainsboro; border-top: none;">
                                <div class="w"
                                    style="width: 49%; float: right; border-left: 1px solid gainsboro; padding: 7px 8px; font-size: 15px;">
                                    {{$doc_r_w_permission_mail_data['read'] == 1 ? 'Granted':'Denied'}}
                                </div>
                                <div style="width: 49%; padding: 7px 8px; font-size: 15px;">
                                    <span><b style="color: #1a2c61;">Read Access:</b></span>
                                </div>
                            </div>
                            <div style="border: 1px solid gainsboro; border-top: none;">
                                <div class="w"
                                    style="width: 49%; float: right; border-left: 1px solid gainsboro; padding: 7px 8px; font-size: 15px;">
                                    {{$doc_r_w_permission_mail_data['write'] == 1 ? 'Granted':'Denied'}}
                                </div>
                                <div style="width: 49%; padding: 7px 8px; font-size: 15px;">
                                    <span><b style="color: #1a2c61;">Write Access:</b></span>
                                </div>
                            </div>
