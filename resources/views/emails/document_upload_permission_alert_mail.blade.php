        ...
        <div class="emailMSG" style="max-width: 600px; margin: 0 auto; border: 1px solid gainsboro;">
            ...
            <div class="emailBox">
                ...
                <div class="msgtext" style="padding: 1.5rem;">
                    <center>
                        <h4 style="margin: .5rem 0; color: #253a76;">Document Upload Permission Update Notification</h4>
                    </center>
                    <p style="font-size: 15px;">Hi, <b style="color: #253a76;">{{$document_upload_permission_alert_mail_data['user_name']}}</b></p>
                    <p style="font-size: 15px;">{{$document_upload_permission_alert_mail_data['message']}}.</p>
                    <div class="userForm">
                        <div class="userDetails">
                            ...
                            <div style="border: 1px solid gainsboro; border-top: none;">
                                <div class="w"
                                    style="width: 49%; float: right; border-left: 1px solid gainsboro; padding: 7px 8px; font-size: 15px;">
                                    {{$document_upload_permission_alert_mail_data['sub_folder']}}
                                </div>
                                <div style="width: 49%; padding: 7px 8px; font-size: 15px;">
                                    <span>{{$document_upload_permission_alert_mail_data['main_folder']}}</span>
                                </div>
                            </div>
                        </div>
                        <div>
