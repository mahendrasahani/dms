...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello {{$single_folder_permission_alert_data['user_name']}},</p>
            <p>{{$single_folder_permission_alert_data['message']}}</p>
    ...
    <tbody> 
            <tr style="background-color: #f9f9f9;">
                <td style="padding: 10px; border: 1px solid #ddd;">{{$single_folder_permission_alert_data['main_folder']}}</td>
                <td style="padding: 10px; border: 1px solid #ddd;">{{$single_folder_permission_alert_data['sub_folder']}}</td>
            </tr>
