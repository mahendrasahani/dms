...
<html dir="ltr">
  ...
  <body>
    <div class="main-wrapper">
      ...
      <div class="auth-wrapper d-flex  no-block justify-content-center align-items-center" style="background: url({{url('public/assets/backend/assets/images/big/auth-bg.jpg')}}) no-repeat center center;   background-size: cover;  " >
                  ...
                  <div class="form-group">
                    <div class="d-flex">
                      <div class="checkbox checkbox-info pt-0">
                        ...
                        <label for="checkbox-signup"><span style="color: #fff;">{{ __('Remember me') }}</span></label>
                      </div>
                      <div class="ms-auto">
                        @if (Route::has('password.request'))
                            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('password.request') }}">
