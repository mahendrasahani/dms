...
@section('main-section')
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="department_user" id="department_user" class="select2 js-programmatic form-control" style="width: 100%; height: 36px" required>
        ...
        @if ($items->isNotEmpty())
                ...
                <div class="section-container"> 
                    <div class="d-flex align-items-center mb-3 label-1 {{'lable_'.$categoryName}}">
                        ...
                        <input type="hidden" name="item_name_{{$item->id}}" value="{{$item->item_name ?? ''}}" {{$item->is_checked == 0 ? 'disabled':''}}>
                        <div class="row">
                            <div class="row">   
                                <div class="col-md-4">  
    ...
    @endforeach
               ...
               <center>
                <button type="submit" class="btn  btn-info font-weight-medium rounded-pillc px-4" value="Submit" style="margin-top: 20px;">
...
@section('javascript-section')
    ...
    <!-- <script>
        ...
        $(document).on("keyup", "#make_model", async function(){
           
            let id = $(this).data('item_id');
            console.log(id);
            let value = $(this).val();
            let response = await fetch(url+'/?id='+id+'make_model='+value);
            let responseData = await response.json();
            console.log(responseData);
        });

        function updateItemData(make_modal, make_and_manufacture, unit_location, qty, status, remark){
