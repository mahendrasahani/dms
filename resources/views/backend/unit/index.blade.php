        ...
        <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
                <nav aria-label="breadcrumb">
                    ...
                    <h1 class="mb-0 fw-bold">Units</h1>
            </div>
            <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
                <a href="{{route('backend.unit.create')}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" style="width:40px" id="status" data-id="{{$unit->id}}" {{$unit->status == 1 ? 'checked':''}}>
                                                </div>
                                            </td>
                                            <td>
                                           <div class="button-container"> 
                                             <a href="{{route('backend.unit.edit', [Crypt::encrypt($unit->id)])}}">
                                                <button class="editBtn">
                                                    ...
                                                    <a href="javascript:void(0)" id="delete_btn" data-id="{{$unit->id}}">
                                                        <button class="button">
...
@section('javascript-section')
    ...
    <script>
        $(document).on("click", "#delete_btn", async function(){
            let id = $(this).data('id'); 
            let url = "{{route('backend.unit.delete')}}";  
            Swal.fire({
                title: "Are you sure?",
                ...
                if (result.isConfirmed){   
                    ...
                    }else if(responseData.status == 'already_in_use'){
                        Swal.fire({
                            title: "Warning!",
                            text: "This unit is already in use with some user. Please remove first !",
                            icon: "warning"
                        });
        ...
        $(document).on('change', '#status', async function(){
            ...
            const url = "{{route('backend.unit.update_status')}}";
