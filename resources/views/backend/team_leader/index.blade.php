    ...
    <div class="page-titles">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
                ...
                <a class="btn btn-info d-flex align-items-center ms-2" href="{{route('backend.team_leader.create')}}">
                                ...
                                <tbody>
                                    ...
                                    @foreach($team_leader as $tl)
                                        ...
                                        <td>{{$sn++}}</td>
                                            <td>{{$tl->name ?? ''}}</td> 
                                            <td>{{$tl->email}}</td> 
                                            <td>{{$tl->getUserHierarchie?->getHeadDepartment?->getDepartmentType?->name}}</td> 
                                            <td>{{$tl->getUserHierarchie?->getHotel?->name}}</td> 
                                            <td>{{$tl->getUserHierarchie?->getHotelDepartment?->name ?? ''}}</td>
                                            <td>
                                            ...
                                            <a href="{{route('backend.assign_folder_permission.assign', [Crypt::encrypt($tl->id)])}}">Folder Permission</a>
                                                <a href="{{route('backend.team_leader.edit', Crypt::encrypt($tl->id))}}">
                                                ...
                                                <a href="{{route('backend.get_manager_list.delete', [Crypt::encrypt($tl->id)])}}">
                                                    <button class="button">
