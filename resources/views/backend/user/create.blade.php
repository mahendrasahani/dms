                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="mt-4" method="POST" action="{{route('backend.user.store')}}" id="create_user_form">
                                ...
                                <div class="row"> 
                                <div class="col-md-6 mt-3" id="unit_list" style="display:none;">
                ...
                if(responseData.status == "success"){
                    ...
                    if(responseData.auth_role == 1){ 
                        html_to_append = `<div class="mb-3 col-md-6">
                                          ...
                                          <select name="department_head" class="select2 hotel form-control" style="width: 100%;" id="department_head" onchange="getUnitList(); removeError('department_head_error');"> 
                ...
                if(responseData.status == "success"){
                    ...
                    if(responseData.auth_role == 1){
                        html_to_append = `<div class="mb-3 col-md-6">
                                          ...
                                          <div class="mb-3 col-md-6">
                                          <lable>Unit</lable>
                                          <select name="unit" class="select2 hotel form-control" style="width: 100%;" id="unit"  onchange="removeError('unit_error'); getManagerList();"> 
                                          <option value="">--Select Unit--</option>
                                          </select>
                                          <p id="unit_error" style="color:red;"></p>
                                          </div>
