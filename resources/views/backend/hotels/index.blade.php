                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <div class="button-container"> 
                                        <a href="{{route('backend.assign_custom_permission', [Crypt::encrypt($hotel->id)])}}">Permission</a> |
                                        <a href="{{route('backend.assign_folder_permission.assign', [Crypt::encrypt($hotel->id)])}}">Folder Permission</a>
                                         
                                                <a href="{{route('backend.hotel.edit', [Crypt::encrypt($hotel->id)])}}">
                                                ...
                                                <a href="{{route('backend.hotel.delete', [Crypt::encrypt($hotel->id)])}}">
                                                    <button class="button">
