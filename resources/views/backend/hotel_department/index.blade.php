                                    ...
                                    @if(count($hotel_departments) > 0)
                                        @foreach($hotel_departments as $hotel_department)
                                            ...
                                            <div class="button-container">
                                                <a href="{{route('backend.employee.assign_permission', [$hotel_department->id])}}">Assign Permission</t</a>
                                                <a href="{{route('backend.hotel_department.edit', [$hotel_department->id])}}">
