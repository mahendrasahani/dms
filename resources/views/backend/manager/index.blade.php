    ...
    <div class="page-titles">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
                ...
                <a class="btn btn-info d-flex align-items-center ms-2" href="{{route('backend.manager.create')}}">
                                    ...
                                    @foreach($managers as $manager)
                                        <tr>
                                            ...
                                            <a href="{{route('backend.assign_folder_permission.assign', [Crypt::encrypt($manager->id)])}}">Folder Permission</a>
                                                ...
                                                <a href="{{route('backend.get_hotel_department_list.delete', [Crypt::encrypt($manager->id)])}}">
                                                    <button class="button">
