    ...
    <div class="page-titles">
        <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
                ...
                <h1 class="mb-0 fw-bold">All Role</h1>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" {{$roles->status === 1 ? 'checked':''}} 
                                                data-id="{{$roles->id}}" value="{{$roles->status}}" 
                                                data-status="{{$roles->status}}" type="checkbox" id="changeStatus" />
                                            </div> 
                                        </td>
                                        <td>
                                            <div class="button-container">
                                                <a href="{{route('backend.create_role.edit', [$roles->id])}}">
                                                ...
                                                <a href="{{route('backend.create_role.delete', [$roles->id])}}">
                                                    <button class="button">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="{{ route('backend.create_role.create') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" placeholder="Category Name" required name="role_name" />
                                                        <label><i data-feather="user" class="sun"></i>&nbsp;Role Name</label>
                                                    </div>
...
@section('javascript-section')
    ...
    <script>
      $(document).on("change", "#changeStatus", function(){
        ...
        console.log(id);
        $.ajax({
                url: "{{route('backend.create_role.update_status')}}",
