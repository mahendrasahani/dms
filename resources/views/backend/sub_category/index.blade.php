                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-container">
                                                ...
                                                <a href="{{route('backend.sub_category.delete', [$sub_cat->id])}}">
                                                <button class="button">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form action="{{route('backend.sub_category.create')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" placeholder="Category Name" require="" name="sub_category_name" />
                                                        <label><i data-feather="user" class="feather-sm text-dark fill-white me-2"></i>Category Name</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" placeholder="Discription" name="sub_category_disc"/>
                                                        <label><i data-feather="mail" class="feather-sm text-dark fill-white me-2"></i>Discription</label>
                                                    </div>
                                                    <div>
                                                        <label style="margin-top:-10px;"><i data-feather="layers" class="feather-sm text-dark fill-white me-2"></i>Select Main Category</label>
