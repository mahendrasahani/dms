    ...
    <div class="page-titles">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
                ...
                <a class="btn btn-info d-flex align-items-center ms-2" href="{{route('backend.team_member.create')}}">
                                ...
                                <tbody>
                                    ...
                                    @foreach($team_member as $member)
                                        <tr>
                                            ...
                                            <td>{{$member->name}}</td> 
                                            <td>{{$member->email}}</td> 
                                            <td>{{$member->getUserHierarchie->getHeadDepartment->getDepartmentType->name}}</td> 
                                            <td>{{$member->getUserHierarchie->getHotel->name}}</td> 
                                            <td>{{$member->getUserHierarchie->getHotelDepartment->name ?? ''}}</td>
                                            <td>{{$member->getUserHierarchie->getManager->name ?? ''}}</td>
                                            <td>{{$member->getUserHierarchie->getTeamLeader->name ?? ''}}</td>
                                            <td>
                                            ...
                                            <a href="{{route('backend.assign_folder_permission.assign', [Crypt::encrypt($member->id)])}}">Folder Permission</a>
                                                ...
                                                <a href="{{route('backend.team_member.delete', [Crypt::encrypt($member->id)])}}">
                                                    <button class="button">
