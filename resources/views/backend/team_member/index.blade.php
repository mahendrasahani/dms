                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered text-nowrap">
                                ...
                                <tbody>
                                    @php $sn = '1'; @endphp
                                    @foreach($team_member as $manager)
                                        <tr>
                                            <td>{{$sn++}}</td>
                                            <td>{{$manager->name}}</td> 
                                            <td>{{$manager->email}}</td> 
                                            <td>{{$manager->getUserHierarchie->getHeadDepartment->getDepartmentType->name}}</td> 
                                            <td>{{$manager->getUserHierarchie->getHotel->name}}</td> 
                                            <td>{{$manager->getUserHierarchie->getHotelDepartment->name ?? ''}}</td>
                                            <td>{{$manager->getUserHierarchie->getManager->name ?? ''}}</td>
                                            <td>{{$manager->getUserHierarchie->getTeamLeader->name ?? ''}}</td>
                                            <td>
