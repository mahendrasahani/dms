        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="mt-4" method="POST" action="{{ route('backend.team_member.store') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <lable>Head Department</lable>
                                        <select name="head_department"  class="select2 hotel form-control"
                                            ...
                                            <option value="{{$head_department->id}}">{{$head_department->getDepartmentType->name}}</option>
                                            @endforeach 
                                        </select>
                                    ...
                                    <lable>Team Leader</lable>
                                        <select name="team_leader"  class="select2 hotel form-control"
                                            style="width: 100%;" id="team_leader" required> 
                                        </select>
                                        @error('team_leader')
                                            <p style="color:red;">{{$message}}</p>
                                            @enderror
