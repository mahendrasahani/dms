                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="form-check-input" {{$main_cat->status === 1 ? 'checked': ''}} value="{{$main_cat->status}}" dat-id="{{$main_cat->status}}" type="checkbox" id="flexSwitchCheckChecked"/>
                                          </div>
                                        </td>
                                        <td>
                                            <div class="button-container">
                                                ...
                                                <a href="{{route('backend.main_category.delete', [$main_cat->id])}}">
                                                <button class="button">
