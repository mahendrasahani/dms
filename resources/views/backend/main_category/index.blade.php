                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" data-id="{{$main_cat->id}}"
                                                            ...
                                                            value="{{ $main_cat->status }}" data-status="{{ $main_cat->status }}"
                                                ...
                                                <td>
                                                    <div class="button-container">
                                                        <a
                                                            href="{{ route('backend.main_category.edit', [$main_cat->id]) }}">
                                                        ...
                                                        <a
                                                            href="{{ route('backend.main_category.delete', [$main_cat->id]) }}">
                                                            <button class="button">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form method="POST" action="{{ route('backend.main_category.store') }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control"
                                                                placeholder="Category Name" required name="category_name" />
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control"
                                                                placeholder="Discription" name="discription" required />
