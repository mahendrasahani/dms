...
<script src="{{ url('public/assets/backend/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js') }}"></script>
...
<script src="{{ url('public/assets/backend/assets/extra-libs/taskboard/js/jquery.ui.touch-punch-improved.js') }}"></script>
<script src="{{ url('public/assets/backend/asse0s/extra-libs/taskboard/js/lobilist.js') }}"></script>
...
<script src="{{ url('public/assets/backend/assets/extra-libs/datatables.net-bs4/js/dataTables.responsive.min.js') }}"></script>
...
<script src="{{ url('public/assets/backend/dist/js/custom.js') }}"></script>

 <!-- Chart JS -->
 <!-- <script src="{{ url('public/assets/backend/dist/js/pages/chartjs/chartjs.init.js') }}"></script>
 <script src="{{ url('public/assets/backend/assets/libs/chart.js/dist/Chart.min.js') }}"></script> -->
