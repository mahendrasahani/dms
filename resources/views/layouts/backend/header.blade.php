            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a href="{{route('backend.main_category.index')}}" class="sidebar-link  waves-effect waves-dark"><i
                                    class="ri-layout-top-2-line"></i><span class="hide-menu">All Main
                                    Category</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('backend.sub_category.index')}}" class="sidebar-link  waves-effect waves-dark"><i
                                    class="ri-layout-right-2-line"></i><span class="hide-menu">All Sub
                                    Category</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('backend.all_document.index')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link  waves-effect waves-dark" href="{{route('backend.login_audit.index')}}"
                        ...
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('backend.user_profile.index')}}" aria-expanded="false"><i
                                    data-feather="users"></i><span class="hide-menu">Profile Page</span></a>
                        </li> --}}
                    </ul>
                </nav>
            </div>
