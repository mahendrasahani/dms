...
<html dir="ltr">
  ...
  <body>
    <div class="main-wrapper">
      ...
      <div class=" auth-wrapper d-flex no-block justify-content-center  align-items-center " style="background: url(<?php echo e(url('public/assets/backend/assets/images/big/auth-bg.jpg')); ?>) no-repeat center center;">
        <div class="auth-box  p-4 card1 rounded">
          <div>
            ...
            <div class="row mt-4">
              <div class="col-12">
                <form class="form-horizontal mt-3 form-material" id="loginform" method="POST" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\dms\resources\views/auth/register.blade.php ENDPATH**/ ?>