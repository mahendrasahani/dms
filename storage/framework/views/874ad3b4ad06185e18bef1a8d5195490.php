...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('assets/backend/assets/libs/apexcharts/dist/apexcharts.css')); ?>" />
    <link href="<?php echo e(url('assets/backend/assets/extra-libs/calendar/calendar.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(url('assets/backend/assets/libs/fullcalendar/dist/fullcalendar.min.css')); ?>"rel="stylesheet" />
    <link rel="canonical" href="https://www.wrappixel.com/templates/flexy-bootstrap-admin-template/" />
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(url('assets/backend/assets/images/favicon.png')); ?>" /> 
    <link rel="stylesheet" href="<?php echo e(url('assets/backend/assets/extra-libs/taskboard/css/lobilist.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(url('assets/backend/assets/extra-libs/taskboard/css/jquery-ui.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/backend/assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')); ?>" />
    <link href="<?php echo e(url('assets/backend/dist/css/style.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(url('assets/backend/dist/css/custom.css')); ?>" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/backend/assets/libs/dropzone/dist/min/dropzone.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/backend/assets/libs/select2/dist/css/select2.min.css')); ?>" />
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" style="background-color: #253a76;">
                    ...
                    <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>">
                        <b class="logo-icon logoicon ">
                            <img src="<?php echo e(url('assets/backend/assets/images/logos.png')); ?>" alt="homepage" class="dark-logo" />
                            <img src="<?php echo e(url('assets/backend/assets/images/logos.png')); ?>" class="light-logo" alt="homepage" />
                        </b>
                        <!-- <span class="logo-text">
                            <img
                            src="<?php echo e(url('assets/backend/assets/images/airport_logol.png')); ?>"
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" style="background-color: #e7e7e7" >
                    <ul class="navbar-nav me-auto d-flex justify-content-between w-100">
                       ...
                       <div class="topNavbarAdd">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('admin.task.index')); ?>" aria-expanded="false">
                        ...
                        <?php endif; ?>
                        <?php if(Auth::user()->role_type_id == 1): ?>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('backend.document_audit.index')); ?>"
                                aria-expanded="false"><span class="hide-menu">Document Audits</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('backend.login_audit.index')); ?>"
                    ...
                    <!-- 
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="<?php echo e(route('backend.check_list.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="<?php echo e(route('backend.assigned_check_list.index')); ?>" aria-expanded="false">
                ...
                $notifications = App\Models\backend\Notification::where('notification_for', Auth::user()->id)->orderBy('id', 'desc')->get();
                                ...
                                <ul class="list-style-none">
                                    <li>
                                        <div class="rounded-top p-30 pb-2 d-flex align-items-center ">
                                            ...
                                            <!-- <span class="badge bg-warning ms-3"><?php echo e(count($notifications)); ?> New</span> -->
                                            <span class="badge bg-warning ms-3"><?php echo e(count($notifications)); ?></span>
                                        </div>
                                    </li>
                                    <li class="p-30 pt-0">
                                        <div class="message-center message-body position-relative">
                                            ...
                                            <a href="<?php echo e($notification->url ?? '#'); ?>"
                                                ...
                                                <div class="w-75 d-inline-block v-middle ps-3 ms-1">
                                                    <h5 class=" message-title mb-0 mt-1 fs-4 font-weight-medium "><?php echo e($notification->title); ?> <span style="font-size: 12px; font-style: italic; color: gray;"><?php echo e($notification->created_at->diffForHumans()); ?></span></h5>
                                                    <span class=" fs-3 text-nowrap d-block time text-truncate fw-normal mt-1 text-muted"><?php echo e($notification->notification); ?></span>
                                                </div>
                                            </a>
                        ...
                        <li class="nav-item dropdown profile-dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center"  href="<?php echo e(route('backend.user_profile.index')); ?>"
                                ...
                                <img src="<?php echo e(url('assets/backend/assets/images/users/default_user.png')); ?>" alt="user" width="30" class="profile-pic rounded-circle" />
                                <?php else: ?>
                                <img src="<?php echo e(url('assets/backend/assets/images/upload/profile_image')); ?>/<?php echo e(Auth::user()->profile_image); ?>" class="rounded-circle" height="50%" />
                                <?php endif; ?>

                                <div class="d-none d-md-flex">
                                    <span class="ms-2">Hi,
                                        <span class="text-dark fw-bold"><?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?></span></span>
                                    <span>
                            ...
                            <div class=" dropdown-menu dropdown-menu-end mailbox dropdown-menu-animate-up ">
                                <ul class="list-style-none">
                                    <li class="p-30 pb-2">
                                        ...
                                        <?php if(Auth::user()->profile_image == NULL): ?>
                                            <img src="<?php echo e(url('assets/backend/assets/images/users/default_user.png')); ?>" alt="user" width="90" class="rounded-circle" />
                                            <?php else: ?>
                                            <img src="<?php echo e(url('assets/backend/assets/images/upload/profile_image')); ?>/<?php echo e(Auth::user()->profile_image); ?>" class="rounded-circle" width="30%" />
                                            <?php endif; ?>
                                            <div class="ms-4">
                                                <h4 class="mb-0"><?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?></h4>
                                                <?php
                                                ...
                                                ?>
                                                    ...
                                                    <?php if($user_role->roleType->id == 2): ?>
                                                    <p><?php echo e($user_role->getDepartmentType?->name); ?></p>
                                                    <?php endif; ?>
                ...
                <nav class="sidebar-nav my-4" >
                    <ul id="sidebarnav" style="background-color: #253a76;">
                        ...
                        <li class="sidebar-item" style="background-color: #253a76;">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link iconcolortext" href="<?php echo e(route('dashboard')); ?>"
                        ...
                        <?php if(Auth::user()->role_type_id == 1 || Auth::user()->role_type_id == 2 || Auth::user()->role_type_id == 5): ?>
                        <li class="sidebar-item" style="background-color: #253a76;">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link iconcolortext" href="<?php echo e(route('backend.user.create')); ?>"
                                aria-expanded="false" style="background-color: #253a76;" >
                        ...
                        <?php if(Auth::user()->role_type_id == 1): ?>
                        <li class="sidebar-item" style="background-color: #253a76;">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link iconcolortext" href="<?php echo e(route('backend.unit.index')); ?>"
                                aria-expanded="false" style="background-color: #253a76;" >
                    ...
                    <?php if(Auth::user()->role_type_id != 7): ?>
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level" style="background-color: #253a76;">
                                <?php if(Auth::user()->role_type_id == 1): ?>
                                   <li class="sidebar-item" style="background-color: #253a76;" >
                                          <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.head_department.index')); ?>" aria-expanded="false">
                                ...
                                <?php endif; ?>
                                    ...
                                    <li class="sidebar-item">
                                    <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.manager.index')); ?>" aria-expanded="false">
                                    <i data-feather="user-check"></i>
                                    ...
                                    <li class="sidebar-item">
                                    <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.team_leader.index')); ?>" aria-expanded="false">
                                    <i data-feather="user-check"></i>
                                    ...
                                    <li class="sidebar-item">
                                    <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.team_member.index')); ?>" aria-expanded="false">
                                    <i data-feather="user-check"></i>
                    ...
                    <?php endif; ?> 
                        ...
                        ?>
                        <li class="sidebar-item">
                            <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.folders.main_folder_list')); ?>" aria-expanded="false">
                                <i data-feather="user-check"></i>
                        ...
                        <?php if(Auth::user()->role_type_id == 1): ?> 
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link iconcolortext" href="<?php echo e(route('backend.document.archived_document')); ?>"
                                    aria-expanded="false">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level" style="background-color: #253a76;">
                                    <li class="sidebar-item">
                                        <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.state.index')); ?>" aria-expanded="false">
                                            <i data-feather="edit-3"></i><span class="hide-menu">State</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.city.index')); ?>" aria-expanded="false">
                                            <i data-feather="edit-3"></i><span class="hide-menu">City</span>
                                        </a>
                                    </li> 
                                   <li class="sidebar-item" style="background-color: #253a76;" >
                                        <a class="sidebar-link  waves-effect waves-dark iconcolortext" href="<?php echo e(route('backend.role_type.index')); ?>" aria-expanded="false">
