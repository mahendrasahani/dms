                ...
                <div class="navbar-header" style="background-color: #253a76;">
                    ...
                    <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>">
                        <b class="logo-icon logoicon ">
                            <img src="<?php echo e(url('public/assets/backend/assets/images/logos.png')); ?>" alt="homepage" class="dark-logo" />
                            <img src="<?php echo e(url('public/assets/backend/assets/images/logos.png')); ?>" class="light-logo" alt="homepage" />
                        </b>
                        <!-- <span class="logo-text">
                            <img
                            src="<?php echo e(url('public/assets/backend/assets/images/airport_logol.png')); ?>"
                ...
                $notifications = App\Models\backend\Notification::where('notification_for', Auth::user()->id)->orderBy('id', 'desc')->get();
                        ...
                        <li class="nav-item dropdown profile-dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center"  href="<?php echo e(route('backend.user_profile.index')); ?>"
                                ...
                                <img src="<?php echo e(url('public/assets/backend/assets/images/users/default_user.png')); ?>" alt="user" width="30" class="profile-pic rounded-circle" />
                                <?php else: ?>
                                <img src="<?php echo e(url('public/assets/backend/assets/images/upload/profile_image')); ?>/<?php echo e(Auth::user()->profile_image); ?>" class="rounded-circle" height="50%" />
                                <?php endif; ?>
                            ...
                            <div class=" dropdown-menu dropdown-menu-end mailbox dropdown-menu-animate-up ">
                                <ul class="list-style-none">
                                    <li class="p-30 pb-2">
                                        ...
                                        <?php if(Auth::user()->profile_image == NULL): ?>
                                            <img src="<?php echo e(url('public/assets/backend/assets/images/users/default_user.png')); ?>" alt="user" width="90" class="rounded-circle" />
                                            <?php else: ?>
                                            <img src="<?php echo e(url('public/assets/backend/assets/images/upload/profile_image')); ?>/<?php echo e(Auth::user()->profile_image); ?>" class="rounded-circle" width="30%" />
                                            <?php endif; ?>
                                            <div class="ms-4">
