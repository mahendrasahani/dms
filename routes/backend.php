...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Route::get('/admin/document/store', [DocumentController::class, 'store'])->name('backend.document.store');
    ...
    // Route::get('/admin/document/update/{id}', [DocumentController::class, 'update'])->name('backend.document.update');
    // Route::get('/admin/document/', [DocumentController::class, 'updateStatus'])->name('backend.document.update_status');
    // Route::get('/admin/document/delete/{id}', [DocumentController::class, 'destroy'])->name('backend.document.delete');
    ...
    // Route::post('/admin/document/comment/{id}', [DocumentController::class, 'commentOnDoc'])->name('backend.document.comment');
    // Route::get('/admin/document/download', [DocumentController::class, 'dwonloadDoc'])->name('backend.document.download');
    ...
    Route::controller(FolderPermissionController::class)->group(function(){
        Route::prefix('/admin/folder-permission')->group(function(){
            Route::get('/{id}', 'assignFolderPermission')->name('backend.assign_folder_permission.assign');
    ...
    Route::controller(FoldersController::class)->group(function () {
        Route::prefix('admin/folders')->group(function () {
            // Route::get('/', 'viewDoc')->name('backend.all_document.folders');
            Route::get('/', 'index')->name('backend.folders.index');
    ...
    Route::controller(HotelController::class)->group(function(){
        Route::prefix('/admin/hotel')->group(function(){
            ...
            // Route::get('update/{id}', 'update')->name('backend.hotel.update');
            // Route::post('delete/{id}', 'destroy')->name('backend.hotel.delete');
        });
    });
    ...
    Route::controller(ManagerController::class)->group(function(){
        Route::prefix('admin/manager')->group(function (){
            ...
            Route::get('edit', 'edit')->name('backend.manager.edit');
            Route::post('update', 'update')->name('backend.manager.update');
